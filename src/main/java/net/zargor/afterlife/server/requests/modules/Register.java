...
public class Register extends Module {
	...
	public DefaultFullHttpResponse onModuleRequest(ChannelHandlerContext ctx, FullHttpReq req) throws Exception {
		...
		PostParameters params = this.getPostParametersAndCheckNull(req, "name", "password", "email", "recaptcha");
		...
		String email = params.getAttributes()[2].getValue();
		String recaptcha = params.getAttributes()[3].getValue();
