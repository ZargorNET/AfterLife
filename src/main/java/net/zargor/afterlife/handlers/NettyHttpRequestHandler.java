...
public class NettyHttpRequestHandler implements ChannelInboundHandler {
    ...
    public NettyHttpRequestHandler() {
        try {
            ...
            moduleHandler.addAllClasses("net.zargor.afterlife.requests.modules", Module.class);
            pageRequestHandler.addAllClasses("net.zargor.afterlife.requests.pages", PageRequest.class);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
