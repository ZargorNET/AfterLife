...
public class SessionManagement {
    ...
    public String createCookieString(String name, String groupName, boolean secure) {
        return String.format("z-sID=%s; Expires=%s; HttpOnly; %s", addSession(name, WebServer.getInstance().getHandler().getGroupM().getGroup(groupName)), DateUtils.addDays(new Date(), 1).toGMTString(), secure ? "Secure;" : "");
    }
